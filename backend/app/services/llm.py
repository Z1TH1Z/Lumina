...
class LLMService:
    ...
    async def generate_embeddings(self, texts: list[str]) -> list[list[float]]:
        ...
        Falls back to zero vectors immediately if Ollama is not reachable,
        preventing startup from blocking when Ollama is not installed.
        """
        # Quick availability check (5s timeout) before spending time per-text
